...
public class CreateEmployeeController extends HttpServlet {
    ...
    private void createEmployee(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Employee inserted successfully with ID: " + employee.getEmployeeId());
            
            // Create system user account using the generated EmployeeID
            boolean userCreated = createSystemUser(employee.getEmployeeId(), username, password);
