...
<head>
    ...
    <title>BetterHR - Tạo mật khẩu mới</title>
    ...
    <main class="auth-shell">
        <section class="auth-brand-panel" aria-label="BetterHR">
            <div class="auth-brand-content">
                <h1>BetterHR</h1>
                <p>Tạo mật khẩu mới để tiếp tục sử dụng hệ thống</p>
            </div>
        </section>
        ...
        <section class="auth-form-panel">
            <div class="auth-card">
                ...
                <div class="auth-header">
                    ...
                    <p>Nhập mật khẩu mới để hoàn tất khôi phục tài khoản.</p>
                </div>

                <form class="auth-form" action="${pageContext.request.contextPath}/changepassRE" method="post">
                    ...
                    <button type="submit" class="auth-button">Lưu mật khẩu</button>
                </form>
            </div>
        </section>
    </main>
