                    ...
                    <form action="${pageContext.request.contextPath}/viewTask" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control readonly" id="status" name="status" value="${task.status}" readonly>
                            </div>
                        </div>
                            ...
                            <div class="employee-grid">
                                <c:forEach var="emp" items="${employeeList}">
                                    <div class="form-check employee-item">
                                        <input class="form-check-input" type="checkbox" name="assignTo" value="${emp.employeeId}" 
                                               id="emp${emp.employeeId}"
                                               <c:forEach var="assignedEmp" items="${assignedEmployees}">
                                                   <c:if test="${assignedEmp.employeeId == emp.employeeId}">checked</c:if>
                                               </c:forEach>>
